...
import { submit_Student_Details } from '../../global/GlobalFunctions';
        ...
        <form>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <textarea className="!rounded-button w-full border-gray-300 focus:border-custom focus:ring-custom drop-shadow-sm" rows="1" placeholder="Enter address"></textarea>
            </div>
